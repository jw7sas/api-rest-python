# imports
from .views import WelcomeView, LoginView, HomeView
...
def appRoutes(app):
    ...
    app.add_url_rule('/login', view_func=LoginView.as_view('login_api'))
    app.add_url_rule('/home', view_func=HomeView.as_view('home_api'))
    return app
